...
func schemaSchemaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema/schema.graphql", size: 735, mode: os.FileMode(420), modTime: time.Unix(1578162893, 0)}
