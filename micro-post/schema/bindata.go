...
func schemaSchemaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema/schema.graphql", size: 586, mode: os.FileMode(420), modTime: time.Unix(1578009564, 0)}
